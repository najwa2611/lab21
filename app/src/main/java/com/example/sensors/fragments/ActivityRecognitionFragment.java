...
public class ActivityRecognitionFragment extends Fragment implements SensorEventListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent, @Nullable Bundle savedInstanceState) {
        ...
        resultView.setBackgroundColor(0xFF4A0E17);
        resultView.setTextColor(0xFFD4AF37);
    ...
    public void onResume() {
        ...
        if (accelerometer != null) {
            ...
            resultView.setText("Accelerometre indisponible.");
        }
    }
    ...
    private String classifyActivity(float x, float y, float z) {
        ...
        if (Math.abs(z) > 8f) return "Stable / telephone a plat";
        if (Math.abs(y) > 7f || Math.abs(x) > 7f) return "Assis ou debout selon l'orientation du telephone";
